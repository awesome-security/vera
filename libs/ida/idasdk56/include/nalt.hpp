...
#define REFINFO_RVAOFF  0x10    // based reference (rva)
...
#define REFINFO_CUSTOM  0x40    // a custom reference
...
#define REFINFO_NOBASE  0x80    // don't create the base xref
...
inline size_t dbg_get_input_path(char *buf, size_t bufsize)
{
