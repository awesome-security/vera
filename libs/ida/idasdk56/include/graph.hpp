...
// GCC complains about missing symbols for mutable_graph_t...
#if !defined(__GNUC__) || defined(__IDP__)
...
#define COLLAPSED_NODE 0x80000000
  ...
  virtual bool idaapi redo_layout(void);
  ...
  virtual bool idaapi set_nrect(int n, const rect_t &r);
  virtual bool idaapi set_edge(edge_t e, const edge_info_t *ei);
