...
#ifdef NO_OBSOLETE_FUNCS        //
        obsolete_calc_arglocs,  // calculate function argument locations
#else                           // This callback is superseded by calc_arglocs2. Do not define it.
        calc_arglocs,           //
                                //
#endif                          //
...
namespace idb_event
{
  enum event_code_t
  {
    ...
    op_type_changed,        // An operand type (offset, hex, etc...) has been set or deleted
                            // in: ea_t ea, int n
    enum_created,           // A enum type has been created
                            // in: enum_t id
    enum_deleted,           // A enum type has been deleted
                            // in: enum_t id
    enum_bf_changed,        // A enum type 'bitfield' attribute has been changed
                            // in: enum_t id
    enum_renamed,           // A enum or member has been renamed
                            // in: tid_t id
    enum_cmt_changed,       // A enum or member type comment has been changed
                            // in: tid_t id, bool repeatable
    enum_const_created,     // A enum member has been created
                            // in: enum_t id, const_t cid
    enum_const_deleted,     // A enum member has been deleted
                            // in: enum_t id, const_t cid
    ...
    changing_op_type,       // An operand type (offset, hex, etc...) is to be changed
                            // in: ea_t ea, int n
    deleting_enum,          // A enum type is to be deleted
                            // in: enum_t id
    changing_enum_bf,       // A enum type 'bitfield' attribute is to be changed
                            // in: enum_t id, bool new_bf
    renaming_enum,          // A enum or enum member is to be renamed
                            // in: tid_t id, bool is_enum, const char *newname
    changing_enum_cmt,      // A enum or member type comment is to be changed
                            // in: tid_t id, bool repeatable, const char *newcmt
    deleting_enum_const,    // A enum member is to be deleted
                            // in: enum_t id, const_t cid
