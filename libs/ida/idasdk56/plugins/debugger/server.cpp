...
int ida_server(DWORD dwInput, BYTE* pInput,
               ...
               IRAPIStream* pStream)
{
  lprintf("IDA " SYSTEM " remote debug server v1.%d.\n"
    "Copyright Hex-Rays 2004-2009\n", IDD_INTERFACE_VERSION);
...
int NT_CDECL main(int argc, char *argv[])
{
  ...
  lprintf("IDA " SYSTEM " remote debug server(" __SERVER_TYPE__ ") v1.%d. Copyright HexRays 2004-2009\n", IDD_INTERFACE_VERSION);
