...
idaman char *ida_export make_visible_name(
        char *dstname,
        const char *srcname,
        size_t dstsize);
...
idaman char *ida_export extract_name(
        const char *line,
        int x,
        char *buf,
        size_t bufsize);
...
idaman char *ida_export get_demangled_name(
        ea_t from,
        ea_t ea,
        char *buf,
        size_t bufsize,
...
idaman char *ida_export get_colored_demangled_name(
        ea_t from,
        ea_t ea,
        char *buf,
        size_t bufsize,
