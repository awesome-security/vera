...
idaman void ida_export ua_dodata(ea_t ea, int dtype);                       // use ua_dodata2
idaman bool ida_export ua_outop(ea_t ea, char *buf, size_t bufsize, int n); // use ua_outop2
idaman bool ida_export ua_stkvar(const op_t &x, adiff_t v);                 // use ua_stkvar2
idaman int ida_export ua_ana0(ea_t ea);                                     // use decode_insn
idaman int ida_export ua_code(ea_t ea);                                     // use create_insn
#endif
