...
inline void append_type(bytevec_t &s, const qtype &str) 
{ 
  append_str(s, *(qstring*)&str); 
}

inline type_t *extract_type(const uchar **ptr, const uchar *end) 
{ 
  return (type_t *)extract_str(ptr, end); 
}
