...
$(IDP_MODULE): $(OBJS) $(IDALIB) $(DEFFILE)
  ifdef LINK_NOBOR
	$(LINKER) $(LINKOPTS) /STUB:../stub /OUT:$@ $(OBJS) $(IDALIB) $(ADDITIONAL_LIBS) user32.lib
	@$(RM) $(@:$(IDP)=.exp) $(@:$(IDP)=.lib)
  else
	$(LINKER) $(LINKOPTS) $(call dospath,$(IDPSTUB) $(OBJS)$(comma)$@$(comma)$(comma)$(IDALIB) $(ADDITIONAL_LIBS) $(IDPSLIB)$(comma)$(DEFFILE))
    ifndef __X64__
	$(PEUTIL) -d$(DEFFILE) $@
    endif
  endif
