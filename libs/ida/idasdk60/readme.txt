        ...
        This SDK should be used with IDA kernel version 6.0.0.100927
...
ida.a    - import library with all exported functions (GNU C++)
  ...
  bor.w32          Borland libraries for IDA32 under MS Windows
  bor.w64          Borland libraries for IDA64 under MS Windows
  gcc.w32          GCC libraries for IDA32 under MS Windows
  gcc.w64          GCC libraries for IDA64 under MS Windows
  gcc32.lnx        GCC libraries for IDA32 under Linux
  gcc32.mac        GCC libraries for IDA32 under Mac OS X
  gcc64.lnx64      GCC libraries for IDA64 under Linux
  gcc64.mac64      GCC libraries for IDA64 under Mac OS X
  vc.w32           Visual Studio libraries for IDA32 under MS Windows
  vc.w64           Visual Studio libraries for IDA64 under MS Windows
  vc.x64           Visual Studio libraries for building 64-bit Windows debugger serber
  ...
  libQt* libraries from IDA directory.
