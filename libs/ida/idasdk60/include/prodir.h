...
idaman int ida_export qfindfirst(const char *pattern, qffblk_t *blk, int attr);
...
idaman int ida_export qfindnext(qffblk_t *blk);

// Stop the file enumeration and free internal structures
//      blk     - file enumeration structure

idaman void ida_export qfindclose(qffblk_t *blk);
