...
idaman error_t ida_export VarGetClassName(const idc_value_t *obj, qstring *name);
...
idaman bool ida_export set_idc_func_ex(
        const char *name,
        idc_func_t *fp,
        const char *args,
        int extfunc_flags);
...
void del_idc_userfuncs(void);           // called at ida exit, deletes idc funcs (set_idc_func)
