...
#define         IDD_INTERFACE_VERSION   13
...
#endif //SWIG
  regval_t(void) : ival(~uint64(0)), rvtype(RVT_INT) {}
  ~regval_t(void) { clear(); }
...
// returns: 2-got event (more events are available), 1-got last event, 0-no event, -1-error
// This function will be called regularly by IDA.
  gdecode_t (idaapi *get_debug_event)(debug_event_t *event, bool ida_is_idle);
