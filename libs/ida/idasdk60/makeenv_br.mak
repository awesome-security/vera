...
all:    w32bor.cfg$(CFGSUF) w64bor.cfg$(CFGSUF)

w32bor.cfg$(CFGSUF):     __bor.cfg
        $(CP) __bor.cfg $@
        echo -nobj\bor.w32$(OBJDIRSUF) >>$@

w64bor.cfg$(CFGSUF):     __bor.cfg
        $(CP) __bor.cfg $@
        echo -nobj\bor.w64$(OBJDIRSUF) >>$@
        @echo -D__EA64__ >>$@

__bor.cfg: makeenv_br.mak allmake.mak defaults.mk
   $(CP) &&|
