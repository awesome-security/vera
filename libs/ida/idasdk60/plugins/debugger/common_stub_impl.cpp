...
int send_debug_names_to_ida(rpc_engine_t *, const ea_t *ea, const char *const *names, int qty)
{
  return ::set_debug_names(ea, names, qty);
}

int send_debug_event_to_ida(rpc_engine_t *, const debug_event_t *ev, int rqflags)
{
