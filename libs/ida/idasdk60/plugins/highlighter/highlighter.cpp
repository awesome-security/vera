...
static gdecode_t idaapi my_get_debug_event(debug_event_t *event, bool ida_is_idle);

// Pointer to old callback
static gdecode_t (idaapi* old_get_debug_event)(debug_event_t *, bool)
  = my_get_debug_event;
...
static gdecode_t idaapi my_get_debug_event(debug_event_t *event, bool ida_is_idle)
{
  gdecode_t code = old_get_debug_event(event, ida_is_idle);  // get debug event
