...
///with freetype fonts.
void print(const font_data &ft_font, float x, float y, bool useWindowCoordinates, const char *fmt, ...)  {
	...
	va_start(ap, fmt);									// Parses The String For Variables
	    vsnprintf(text, sizeof(text)-1, fmt, ap);						// And Converts Symbols To Actual Numbers
